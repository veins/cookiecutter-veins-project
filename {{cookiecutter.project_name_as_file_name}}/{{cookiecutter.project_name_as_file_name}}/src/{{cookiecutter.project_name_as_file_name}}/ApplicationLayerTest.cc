...
#include "{{ cookiecutter.project_name_as_file_name }}/ApplicationLayerTest.h"

#include "{{ cookiecutter.project_name_as_file_name }}/ApplicationLayerTestMessage_m.h"

using namespace veins;
using namespace {{ cookiecutter.project_name_as_file_name }};

Define_Module({{ cookiecutter.project_name_as_file_name }}::ApplicationLayerTest);
